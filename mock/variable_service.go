...
type VariableService struct {
	...
	ReplaceVariableF      func(context.Context, influxdb.ID, *influxdb.Variable) error
...
func NewVariableService() *VariableService {
	return &VariableService{
		...
		ReplaceVariableF: func(context.Context, influxdb.ID, *influxdb.Variable) error { return nil },
		UpdateVariableF: func(ctx context.Context, id influxdb.ID, update *influxdb.VariableUpdate) (*influxdb.Variable, error) {
			return nil, nil
		},
	}
...
func (s *VariableService) ReplaceVariable(ctx context.Context, id influxdb.ID, variable *influxdb.Variable) error {
	...
	return s.ReplaceVariableF(ctx, id, variable)
}
